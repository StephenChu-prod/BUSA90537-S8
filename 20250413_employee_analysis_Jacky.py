...
class EmployeeAnalyser:
    ...
    def additional_columns(self):
        ...
        # Group by the new 'Employee' column and 'Year_week'
    ...
    def summary(self, frequency: Literal['weekly', 'monthly'], pivot: bool=False):
        if frequency == 'weekly':
...
if __name__ == '__main__':
    ...
    analyser.summary(frequency='weekly', pivot=True)
